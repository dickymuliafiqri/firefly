...
- **Google Antigravity Cloud Code Adapter (`internal/antigravity`):** Translates incoming OpenAI inference requests into Google Cloud Code internal protocols with authentic Google Cloud companion project binding, supporting Gemini 3.8/3.7 Flash tiers, Gemini 2.5 Pro/Flash, and Claude 3.7/4.6 Sonnet inference models with non-blocking OAuth onboarding.
